...
class Scribe:
    ...
    def __init__(self, csv_path: str, client_params: str):
        ...
        openai.api_key = "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"
...
class GUI:
    def __init__(self, master):
        ...
        self.run_button = tk.Button(self.master, text="Find File & Run", command=self.run)
    ...
    def run(self):
        Scribe(csv_path=self.browseFiles(),
